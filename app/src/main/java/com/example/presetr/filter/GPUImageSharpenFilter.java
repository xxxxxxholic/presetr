...
public class GPUImageSharpenFilter extends GPUImageFilter {
    ...
    public static final String FRAGMENT = GlUtil.getStringFromRaw(R.raw.filter_sharpen_fs, false);
...
//    private int imageSizePos;
    ...
    public void onInit() {
        ...
        radiusPos = GLES20.glGetUniformLocation(getProgram(), "radius");
//        imageSizePos = GLES20.glGetUniformLocation(getProgram(), "imgSize");
    }
    ...
    public void onOutputSizeChanged(final int width, final int height) {
        ...
        setFloat(imageWidthFactorLocation, width);
        setFloat(imageHeightFactorLocation, height);
//        setFloatVec2(imageSizePos, new float[] {width, height});
    }

    public void setRadius(final float radius) {
        this.radius = radius;
        setFloat(radiusPos, this.radius);
    }
